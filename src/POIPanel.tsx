...
// export default function POIPanel({ room }: Props) {
//   const [selected, setSelected] = useState<POIData | null>(null);

//   return (
//     <>
//       {/* POI List button strip */}
//       <div
//         style={{
//           position: "absolute",
//           bottom: 24,
...
//           <button
//             key={poi.id}
//             onClick={() => setSelected(selected?.id === poi.id ? null : poi)}
//             title={poi.label}
//             style={{
//               background: selected?.id === poi.id ? "rgba(255,179,0,0.95)" : "rgba(20,20,30,0.82)",
//               color: "#fff",
...
//           }}
//         >
//           <div style={{ fontSize: 22, marginBottom: 6 }}>{selected.icon}</div>
//           <div style={{ fontWeight: 700, fontSize: 15, marginBottom: 4 }}>{selected.label}</div>
//           {selected.description && (
//             <div style={{ fontSize: 13, opacity: 0.75, lineHeight: 1.5 }}>{selected.description}</div>
//           )}
//           <button
